...
// permet de visualiser l'ensemble des blocks

app.get("/blocks", (req, res) => {
  res.json(blockchain.chain);
});

// permet l'ajout de block dans la chaine
...
blockchain.addNewNode(
  socketListener(client(`http://localhost:${PORT}`), blockchain)
);
